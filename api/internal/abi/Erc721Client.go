...
func (_Abi *AbiCaller) TokenURI(opts *bind.CallOpts, tokenId_ *big.Int) (string, error) {
	var out []interface{}
	err := _Abi.contract.Call(opts, &out, "tokenURI", tokenId_)
...
//
// Solidity: function tokenURI(uint256 tokenId_) view returns(string)
func (_Abi *AbiSession) TokenURI(tokenId_ *big.Int) (string, error) {
	return _Abi.Contract.TokenURI(&_Abi.CallOpts, tokenId_)
}

// TokenURI is a free data retrieval call binding the contract method 0xc87b56dd.
//
// Solidity: function tokenURI(uint256 tokenId_) view returns(string)
func (_Abi *AbiCallerSession) TokenURI(tokenId_ *big.Int) (string, error) {
	return _Abi.Contract.TokenURI(&_Abi.CallOpts, tokenId_)
}
