...
var file_proto_v1_web3_gateway_service_proto_rawDesc = []byte{
	...
	,
...
var file_proto_v1_web3_gateway_service_proto_goTypes = []interface{}{
	...
	(*FundIrysReq)(nil),       // 1: web3_gateway.FundIrysReq
	(*UploadContentResp)(nil), // 2: web3_gateway.UploadContentResp
	(*FundIrysResp)(nil),      // 3: web3_gateway.FundIrysResp
}
var file_proto_v1_web3_gateway_service_proto_depIdxs = []int32{
	...
	1, // 1: web3_gateway.StorageService.FundIrysAccount:input_type -> web3_gateway.FundIrysReq
	2, // 2: web3_gateway.StorageService.UploadContent:output_type -> web3_gateway.UploadContentResp
	3, // 3: web3_gateway.StorageService.FundIrysAccount:output_type -> web3_gateway.FundIrysResp
...
type StorageServiceClient interface {
	...
	FundIrysAccount(ctx context.Context, in *FundIrysReq, opts ...grpc.CallOption) (*FundIrysResp, error)
}
...
func (c *storageServiceClient) FundIrysAccount(ctx context.Context, in *FundIrysReq, opts ...grpc.CallOption) (*FundIrysResp, error) {
	out := new(FundIrysResp)
	err := c.cc.Invoke(ctx, "/web3_gateway.StorageService/FundIrysAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StorageServiceServer interface {
	...
	FundIrysAccount(context.Context, *FundIrysReq) (*FundIrysResp, error)
}
...
func (*UnimplementedStorageServiceServer) FundIrysAccount(context.Context, *FundIrysReq) (*FundIrysResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FundIrysAccount not implemented")
}
...
func _StorageService_FundIrysAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FundIrysReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StorageServiceServer).FundIrysAccount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/web3_gateway.StorageService/FundIrysAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StorageServiceServer).FundIrysAccount(ctx, req.(*FundIrysReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _StorageService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FundIrysAccount",
			Handler:    _StorageService_FundIrysAccount_Handler,
		},
	},
